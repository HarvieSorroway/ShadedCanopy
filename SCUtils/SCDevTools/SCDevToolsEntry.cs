...
namespace SCUtils.SCDevTools
{
    ...
    public class _SCMorningGlory
    {
        ...
        [SCDevToolsInspectValue]
        public float coverWidthCurvePct = 0.2f;
        //[SCDevToolsInspectValue]
        ...
        [SCDevToolsInspectValue]
        public float leafWidthMin = 0.2f;
        [SCDevToolsInspectValue]
        public float leafWidthMax = 0.4f;
        [SCDevToolsInspectValue]
        public float leafLengthMin = 0.65f;
        [SCDevToolsInspectValue]
        public float leafLengthMax = 0.85f;
        [SCDevToolsInspectValue]
        public float leafAngleMin = 25f;
        [SCDevToolsInspectValue]
        public float leafAngleMax = 40f;
        //[SCDevToolsInspectValue]
        ...
        //[SCDevToolsInspectValue]
        public float stalkWidthOffsetMin = -1f;
        //[SCDevToolsInspectValue]
        public float stalkWidthOffsetMax = 1f;

        // 颜色战地过大 最好放最后
        //[SCDevToolsInspectValue]
        public UnityEngine.Color stalkColorRangeLeft = new UnityEngine.Color(0x27 / 255f, 0x4d / 255f, 0x3d / 255f);
        //[SCDevToolsInspectValue]
        public UnityEngine.Color stalkColorRangeRight = new UnityEngine.Color(0x00 / 255f, 0x7d / 255f, 0x65 / 255f);
    }
