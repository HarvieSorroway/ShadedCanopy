...
namespace ShadedCanopy.Iterators.MechIterator
{
    internal class MechIteratorGraphic
    {
        ...
        public bool ReadyForBehaviourAction => (currentAnimation != null && currentAnimation.ReadyForBehaviourAction) || currentAnimation == null;
        ...
        void SwitchAnimation(AnimationID newAnim)
        {
            ...
            else if(newAnim == AnimationID.LootAtPlayer)
            {
                newAnimation = new LookAtPlayerAnimation(this);
            }
        ...
        internal class Animation
        {
            ...
            public virtual bool ReadyForBehaviourAction => true;
        ...
        internal class IdleAnimation : Animation
        {
            ...
            public override bool ReadyForBehaviourAction => timeInAnim >= 40;
            ...
            public override void Update()
            {
                ...
                else
                {
                    ...
                    //{
                    //    graphic.RequestSwitchAnimation(AnimationID.LootAtPlayer);
                    //}
                }
            }
        }

        internal class LookAtPlayerAnimation : Animation
        {
            float initExpand;
            public override bool AllowSwitch => timeInAnim > 40;

            public override bool ReadyForBehaviourAction => timeInAnim >= 80;

            public LookAtPlayerAnimation(MechIteratorGraphic graphic) : base(graphic)
            {
                initExpand = graphic.Expand;
            }
        ...
        internal class AnimationID : ExtEnum<AnimationID>
        {
            ...
            public static readonly AnimationID LootAtPlayer = new AnimationID("NoticePlayer", true);
